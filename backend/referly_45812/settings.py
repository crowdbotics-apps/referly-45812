"""
Django settings for referly_45812 project.
...
ROOT_URLCONF = 'referly_45812.urls'
...
WSGI_APPLICATION = 'referly_45812.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "referly_45812 API",
    "DESCRIPTION": "API documentation for referly_45812 App",
    "VERSION": "v1",
}
